...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash('Your account has been successfully created! Login to continue..', 'success')
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email has been sent to you with instrutions to reset your password.', 'info')
        return redirect(url_for('login'))
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your password has been reset succesfully! Login to continue..', 'success')
        return redirect(url_for('login'))
